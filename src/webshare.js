...
const compareStreams = (a, b) => {
  if (a.strongMatch && b.strongMatch) {
    // Compare strong matches by match, positive votes and size
    ...
    // Compare weak matches by match, fulltextMatch, positive votes and size
    if (a.match != b.match) return b.match - a.match;
    ...
    // One is strong and the other is not, compare by match
